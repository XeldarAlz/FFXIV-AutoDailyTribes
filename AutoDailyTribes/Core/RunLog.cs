...
// console instead of digging the [ADT] lines out of dalamud.log. IPC callbacks and file loads log
...
public static class RunLog
{
    ...
    {
        Svc.Log.Warning(exception, $"{AdtConstants.LogPrefix} {message}");
    ...
    {
        Svc.Log.Error(exception, $"{AdtConstants.LogPrefix} {message}");

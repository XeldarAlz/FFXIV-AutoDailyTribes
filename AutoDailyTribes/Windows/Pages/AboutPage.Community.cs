...
internal sealed partial class AboutPage
{
    ...
    [
        new("##adt_about_discord", FontAwesomeIcon.Comments, L.About.DiscordTitle, L.About.DiscordBody, DiscordUrl, Styling.AccentDiscord),
        new("##adt_about_github", FontAwesomeIcon.CodeBranch, L.About.GitHubTitle, L.About.GitHubBody, RepoUrl, Styling.AccentViolet),
    ];
